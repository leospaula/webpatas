...
ActiveRecord::Schema.define(version: 20150720161708) do
  ...
  add_index "product_accesses", ["product_id"], name: "index_product_accesses_on_product_id", using: :btree
  ...
  add_index "store_accesses", ["store_id"], name: "index_store_accesses_on_store_id", using: :btree
  ...
  add_foreign_key "store_accesses", "stores"
